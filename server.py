...
async def handle_build(target: str) -> str:
    ...
    # Keep a task file in the project directory for manual inspection.
...
async def api_settings_status():
    ...
    claude_installed = secondary_agent_installed() if SECONDARY_AGENT.cli_name == "claude" else False
    ...
    return {
        "secondary_agent_name": SECONDARY_AGENT.display_name,
        "secondary_agent_cli": SECONDARY_AGENT.cli_name,
        "secondary_agent_installed": secondary_agent_installed(),
